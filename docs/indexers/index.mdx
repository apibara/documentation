...
mode](/docs/indexers/factory-mode). Factory mode changes the indexer behavior
...
- `filter`: the filter used to select onchain data. [Learn more about data filtering here](/docs/indexers/filter).
...
Refer to the [editor setup page](/docs/indexers/editor-setup) to learn how to
...
here](/docs/indexers/permissions/network)).
