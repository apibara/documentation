...
Scripts need to export tat least two things:
...
- Learn how to use NPM packages in your indexers.
- Learn how to access environment variables.
- Learn how to use `fetch` from an indexer.
- View all the available configuration options.
- Test your indexer.
