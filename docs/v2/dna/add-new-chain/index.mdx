...
This page explains how to add support for a new chain to the DNA protocol. It is recommended that you're familiar with the high-level [DNA architecture](/docs/v2/dna/architecture) and the [DNA streaming protocol](/docs/v2/dna/streaming-protocol) before reading this page.
...
detail how indices work, the important part is that:
 ...
 - Indices are grouped by the type of data they index (e.g. transactions, logs, and traces).
...
This `Filter` specifies:
 ...
 - What resource to filter (e.g. transactions, logs, and traces).
